...
opcode_entry opcode_table [512] = {
  ...
  /* 0x28 */	IDEXW(G2E,sub,1), IDEXW(G2E,sub,1), IDEXW(G2E,sub,1), IDEXW(E2G,sub,1),
  /* 0x2c */	IDEXW(E2G,sub,1), IDEXW(E2G,sub,1), EMPTY, EMPTY,
  /* 0x30 */	IDEXW(G2E,xor,1), IDEXW(G2E,xor,1), IDEXW(E2G,xor,1), IDEXW(E2G,xor,1),
  /* 0x34 */	IDEXW(I2r,xor,1), IDEXW(I2r,xor,1), EMPTY, EMPTY,
